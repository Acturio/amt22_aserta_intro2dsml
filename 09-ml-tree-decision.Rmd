...
```{r echo=FALSE,fig.align='center', out.height='350pt', out.width='600pt'}
knitr::include_graphics("img/09-ml-tree/bagging-boosting.jpeg")
```
...
knitr::include_graphics("img/09-ml-tree/boosting2.png")
```
...
knitr::include_graphics("img/09-ml-tree/boosting.png")
```
...
```{r echo=FALSE,fig.align='center', out.height='350pt', out.width='600pt'}
knitr::include_graphics("img/09-ml-tree/boosting-training.png")
```
...
knitr::include_graphics("img/09-ml-tree/boosting-predicciones.png")
```
...
```{r echo=FALSE,fig.align='center', out.height='400pt', out.width='800pt'}
knitr::include_graphics("img/09-ml-tree/sequential_trees.png")
```


## Implementación de XGB en R
...
```{r}
xgboost_reg_tune_result %>% autoplot() 
```
