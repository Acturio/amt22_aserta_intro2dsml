...
4. Construya una matriz identidad de dimensión  3×3. Recuerde que una matriz identidad tiene sólo unos en la diagonal principal y los demás elementos son cero.
...
7. ¿Cuál es el error al ejecutar el siguiente código? ¿A qué se debe? 
