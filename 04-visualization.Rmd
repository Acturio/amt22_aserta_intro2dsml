...
```{r echo=FALSE,fig.align='center', out.width = "500pt"}
  knitr::include_graphics("img/04-ggplot/meme-tecnicamente.png")
```
...
```{r echo=FALSE,fig.align='center', out.width = "600pt"}
  knitr::include_graphics("img/04-ggplot/bad_viz1.png")
```

```{r echo=FALSE,fig.align='center', out.width = "700pt"}
  knitr::include_graphics("img/04-ggplot/bad_viz2.png")
```

{r echo=FALSE,fig.align='center', out.width = "700pt"} knitr::include_graphics("img/04-ggplot/bad_viz3.png")

```{r echo=FALSE,fig.align='center', out.width = "700pt"}
  knitr::include_graphics("img/04-ggplot/bad_viz4.jpg")
```

```{r echo=FALSE,fig.align='center', out.width = "700pt"}
  knitr::include_graphics("img/04-ggplot/bad_viz5.png")
```

```{r echo=FALSE,fig.align='center', out.width = "700pt"}
  knitr::include_graphics("img/04-ggplot/bad_viz6.jpg")
```
...
knitr::include_graphics("img/04-ggplot/tinta.png")
```
...
diamonds %>% 
  ...
  geom_text(aes(label = ..count..), stat = "count", vjust = 1, hjust = 1.1,colour = "white")+
  scale_x_continuous(labels = scales::comma_format()) +
