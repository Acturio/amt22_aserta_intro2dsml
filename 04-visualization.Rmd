...
knitr::include_graphics("img/05-ggplot/tinta.png")
```
...
knitr::include_graphics("img/05-ggplot/histograma.jpg")
```
...
```{r echo=FALSE, out.width = "500pt", out.height="250pt",fig.align='center'}
knitr::include_graphics("img/05-ggplot/boxplot.png")
```
...
```{r echo=FALSE, out.width = "500pt", out.height="250pt",fig.align='center'}
knitr::include_graphics("img/05-ggplot/barras.jpg")
```
...
knitr::include_graphics("img/05-ggplot/pie.jpg")
```
...
knitr::include_graphics("img/05-ggplot/dispersion.png")
```
...
knitr::include_graphics("img/05-ggplot/lineas.jpg")
```
